...
const PortofolioDua = ({ lang = 'id' }) => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-fixed text-[#392F43] font-barrio py-16 px-6 overflow-hidden" style={{ backgroundImage: "url('/assets/backgroundfpe.jpeg')" }}>

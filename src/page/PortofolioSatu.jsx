...
const Portfolio = ({ lang = 'id' }) => {
  ...
  // State baru untuk menyimpan gambar yang di-klik
  ...
  return (
    <div className="relative min-h-screen bg-neo-black text-gray-300 font-sans selection:bg-fuchsia-500 selection:text-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 py-12 space-y-24">
          ...
          <section id="about" className="flex flex-col md:flex-row gap-12 items-center justify-between">
            ...
            <div className="flex-shrink-0 w-full md:w-auto flex justify-center">
              <div className="relative group cursor-pointer" onClick={() => setSelectedImage(myrealphoto)}>
                ...
                <img 
                  src={myrealphoto} 
                  alt="Profile" 
                  className="relative w-60 h-60 md:w-72 md:h-72 object-cover rounded-2xl border-2 border-gray-800 shadow-xl group-hover:scale-105 transition-transform duration-300"
                />
              </div>
            </div>
          </section>
          ...
          <section id="projects" className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="group bg-neo-card rounded-xl overflow-hidden border border-gray-800 hover:border-purple-500 hover:-translate-y-1 transition-all duration-300 shadow-lg">
                <div 
                  className="h-48 bg-gray-900 relative overflow-hidden flex items-center justify-center border-b border-gray-800 cursor-pointer"
                  onClick={() => setSelectedImage(project1Image)}
                >
                  <span className="text-gray-600 font-mono tracking-widest text-sm w-full h-full">
                    <img src={project1Image} alt="Project 1" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                  </span>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 text-xs rounded-full bg-blue-400/10 text-blue-400 border border-blue-400/20">React.js</span>
                    <span className="px-3 py-1 text-xs rounded-full bg-blue-600/10 text-blue-600 border border-blue-600/20">Tailwind CSS</span>
                    <span className="px-3 py-1 text-xs rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">Node.js</span>
                  ...
                  <div className="pt-4 flex gap-6 border-t border-gray-800/60">
                    <h1 className="text-sm font-semibold text-white flex items-center gap-2 transition-colors">Demo →</h1>
                    <a href="https://github.com/SKARIGA-RPL-XII/project-kka-SavimbiPride.git" className="text-sm font-semibold text-gray-400 hover:text-purple-500 transition-colors">GitHub</a>
                  </div>
                </div>
              </div>
              ...
              <div className="group bg-neo-card rounded-xl overflow-hidden border border-gray-800 hover:border-emerald-500 hover:-translate-y-1 transition-all duration-300 shadow-lg">
                <div 
                  className="h-48 bg-gray-900 relative overflow-hidden flex items-center justify-center border-b border-gray-800 cursor-pointer"
                  onClick={() => setSelectedImage(project2Image)}
                >
                  <span className="text-gray-600 font-mono tracking-widest text-sm w-full h-full">
                    <img src={project2Image} alt="Project 2" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                  </span>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 text-xs rounded-full bg-blue-500/10 text-blue-200 border border-blue-500/20">React native expo</span>
                    <span className="px-3 py-1 text-xs rounded-full bg-emerald-500/10 text-emerald-700 border border-emerald-500/20">Android Studio</span>
                    <span className="px-3 py-1 text-xs rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">Node.js</span>
                    <span className="px-3 py-1 text-xs font-semibold rounded-full bg-yellow-500/10 border border-yellow-500/20">
                      <span className="text-black-100">Express</span>
                      <span className="text-yellow-400">.js</span>
                  ...
                  <div className="pt-4 flex gap-6 border-t border-gray-800/60">
                    <h1 className="text-sm font-semibold text-white flex items-center gap-2 transition-colors">Demo →</h1>
                    <a href="https://github.com/SKARIGA-RPL-XII/repo-tugas-mobile-app-mobile.git" className="text-sm font-semibold text-gray-400 hover:text-emerald-500 transition-colors">GitHub</a>
                  </div>
                </div>
              </div>
              ...
              <div className="group bg-neo-card rounded-xl overflow-hidden border border-gray-800 hover:border-blue-500 hover:-translate-y-1 transition-all duration-300 shadow-lg">
                <div 
                  className="h-48 bg-gray-900 relative overflow-hidden flex items-center justify-center border-b border-gray-800 cursor-pointer"
                  onClick={() => setSelectedImage(project3Image)}
                >
                  <span className="text-gray-600 font-mono tracking-widest text-sm w-full h-full">
                    <img src={project3Image} alt="Project 3" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                  </span>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="pt-4 flex gap-6 border-t border-gray-800/60">
                    <h1 className="text-sm font-semibold text-white hover:text-blue-500 flex items-center gap-2 transition-colors">Demo →</h1>
                    <a href="https://github.com/SavimbiPride/karisma-v2.git" className="text-sm font-semibold text-gray-400 hover:text-blue-500 transition-colors">GitHub</a>
                  </div>
                </div>
              </div>
          ...
          <section id="certificates" className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="group bg-neo-card rounded-xl overflow-hidden border border-gray-800 hover:border-blue-500 transition-all duration-300 shadow-lg flex flex-col">
                <div 
                  className="h-48 bg-gray-900 relative overflow-hidden flex items-center justify-center border-b border-gray-800 cursor-pointer"
                  onClick={() => setSelectedImage(sertifikasi1)}
                >
                  <span className="text-gray-600 font-mono tracking-widest text-sm w-full h-full">
                    <img src={sertifikasi1} alt="Sertifikat 1" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                  </span>
                  <div className="absolute inset-0 bg-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                </div>
                ...
                <div className="p-6 flex flex-col justify-between flex-1 space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 text-blue-400 font-medium text-sm">
                      <img src={hummas} className="w-5 h-5 object-contain shrink-0 rounded-sm" />
              ...
              <div className="group bg-neo-card rounded-xl overflow-hidden border border-gray-800 hover:border-blue-900 transition-all duration-300 shadow-lg flex flex-col">
                <div 
                  className="h-48 bg-gray-900 relative overflow-hidden flex items-center justify-center border-b border-gray-800 cursor-pointer"
                  onClick={() => setSelectedImage(sertifikasi2)}
                >
                  <span className="text-gray-600 font-mono tracking-widest text-sm w-full h-full">
                    <img src={sertifikasi2} alt="Sertifikat 2" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                  </span>
                ...
                <div className="p-6 flex flex-col justify-between flex-1 space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 text-blue-900 font-medium text-sm">
                      <img src={karisma} className="w-5 h-5 object-contain shrink-0 rounded-sm" />
          ...
          <section id="contact" className="py-12 border-t border-gray-800 text-center space-y-6">
            ...
            <div className="flex justify-center gap-6 pt-4">
              ...
              <a href="https://discord.gg/WZKNFYPfNZ" className="group flex items-center justify-center w-12 h-12 rounded-full bg-neo-card border border-gray-700 hover:border-[#5865F2] hover:shadow-[0_0_15px_rgba(88,101,242,0.5)] transition-all duration-300">
              ...
              <a href="https://www.instagram.com/ravlores/?hl=en" className="group flex items-center justify-center w-12 h-12 rounded-full bg-neo-card border border-gray-700 hover:border-pink-500 hover:shadow-[0_0_15px_rgba(236,72,153,0.5)] transition-all duration-300">
              ...
              <a href="https://github.com/SavimbiPride" className="group flex items-center justify-center w-12 h-12 rounded-full bg-neo-card border border-gray-700 hover:border-white hover:shadow-[0_0_15px_rgba(255,255,255,0.5)] transition-all duration-300">
      ...
      {selectedImage && (
        <div
          className="fixed inset-0 z-[110] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 transition-opacity duration-300"
          onClick={() => setSelectedImage(null)}
        >
          <div className="relative max-w-5xl max-h-[90vh] w-full flex justify-center items-center mt-10 md:mt-0">
            
            <button 
              className="absolute -top-10 right-0 md:-right-12 md:top-0 text-gray-300 hover:text-white bg-gray-800/80 hover:bg-red-500 rounded-full p-2 transition-colors duration-200 z-50"
              onClick={() => setSelectedImage(null)}
            >
            ...
            <img 
              src={selectedImage} 
              alt="Enlarged view" 
              className="max-w-full max-h-[85vh] object-contain rounded-xl shadow-2xl animate-in zoom-in duration-300"
              onClick={(e) => e.stopPropagation()} // Mencegah modal tertutup kalau gambar yang di-klik
            />
          </div>
        </div>
      )}
